...
//   //Define LLM - Updated to use Gemini Flash 2.0
//   const llm = new ChatGoogleGenerativeAI({
//     apiKey: process.env.API_KEY,
//     modelName: "gemini-flash-2.0", // Updated to Gemini Flash 2.0
//     temperature: 0.7,
//     maxOutputTokens: 2048, // Optional: Set your preferred output token limit
//   });
...
//   //embeddings - consider using the matching embeddings model
//   const embeddings = new GoogleGenerativeAIEmbeddings({
//     apiKey: process.env.API_KEY,
//     modelName: "embedding-001", // Keep using this or check if a matching embeddings model is available
//   });
...
//         namespace: namespace,
//       });
//       console.log("completed store creation", store);
//     } catch (error) {
//       console.log(error);
//     }
//   }
//   // await addDocs()  // Uncomment if you need to add docs
